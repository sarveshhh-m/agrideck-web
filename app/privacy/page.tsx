      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">We collect the following personal information when you register and use our services:</p>
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">2.2 Listing and Transaction Information</h3>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              To exercise these rights, please contact us at privacy@agrideck.com or through the app settings.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">Our app uses the following third-party services:</p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <ul className="list-none text-gray-700 space-y-2">
              <li><strong>Email:</strong> privacy@agrideck.com</li>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">13. Open Source Disclosure</h2>
            <p className="text-gray-700">
