      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">To use Agrideck, you must:</p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">You may register as either a Farmer or Buyer:</p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">5.1 For Farmers</h3>
            <p className="text-gray-700 mb-4">As a farmer, you agree to:</p>
            <ul className="list-disc pl-6 mb-4 text-gray-700 space-y-2">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">5.2 For Buyers</h3>
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">7. Transactions and Payment</h2>

            <h3 className="text-xl font-semibold text-gray-900 mb-3">7.1 Platform Role</h3>
            <p className="text-gray-700 mb-4">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-3">7.3 Fees</h3>
            <p className="text-gray-700">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">13. Modifications to Service and Terms</h2>
            <p className="text-gray-700 mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">14. Open Source</h2>
            <p className="text-gray-700">
